...
SHOW_ITEM_RECT(CMD_Rectangle,Skin104Rect,0,0,81,24,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin104)
SHOW_MAP_BODY(Skin104Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin104,0,0,81,24)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text106,0,0,81,24,STRID_NULL,0,1280,0,0,3,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal103)
SHOW_MAP_BODY(Skin104)
SHOW_MAP_BODY(Text106)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal103,84,34,165,58)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovPlayTime,0,84,34,165,58)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin134Rect,0,0,81,22,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin134)
SHOW_MAP_BODY(Skin134Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin134,0,0,81,22)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text136,0,0,81,22,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal133)
SHOW_MAP_BODY(Skin134)
SHOW_MAP_BODY(Text136)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal133,84,7,165,29)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovTotalTime,0,84,7,165,29)
