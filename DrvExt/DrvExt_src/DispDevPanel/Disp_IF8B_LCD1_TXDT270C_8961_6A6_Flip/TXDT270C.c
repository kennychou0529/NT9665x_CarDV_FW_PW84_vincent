...
const tPANEL_CMD tCmdModeRgbd320[] =
{
    ...
    {0x11,0x30},//{0x11,0x50},//b 亮度
    //{0x10,0x50},
    {0x0f,0x30},//{0x0f,0x50},//r 亮度
    //0x03  brightness
   // {0x0f,0x50},
   {0x03,0x20},
#endif
...
{0x05, 0x1E},  //set power mode (standby)
	...
	{0x00,0x0b}, 
	{0x01,0xea}, //0xb8//f0//e8
	{0x0b,0x80}, 
	
	{0x0d,0x38}, //Contrast -- 0x30
	{0x03,0x30}, //Brightness -- 0x38
	
	{0x0e,0x49},//R Bright
	{0x0f,0x41},//R Contrast

	{0x10,0x40},//B Bright
	{0x11,0x40},//R Contrast
