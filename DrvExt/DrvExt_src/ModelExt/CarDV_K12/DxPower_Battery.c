...
// V = ADC*4.2/910
#define VOLDET_BATTERY_420V         625//860//vincent@20150910-3
#define VOLDET_BATTERY_395V         608//795
#define VOLDET_BATTERY_380V         586//771
#define VOLDET_BATTERY_375V         570//750
#define VOLDET_BATTERY_355V         550//735
...
static UINT32 DrvPower_GetBatteryLevel(void)
{
    ...
    // Rising
    debug_msg("DrvPower_GetBatteryLevel:uiCurBatteryADC = %d\r\n", uiCurBatteryADC);
