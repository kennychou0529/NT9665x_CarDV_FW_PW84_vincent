...
#include "GxSound.h"
#include "debug.h"
#include "../../../UIWnd/d480x272/UIInfo/UIInfo.h"//vincent@20150922-1
...
#if(_MODEL_DSC_==_MODEL_DUAL_D333_)//vincent@20150902-3
    if ((UI_GetData(FL_BEEP)== BEEP_ON) || (index==DEMOSOUND_SOUND_POWERON_TONE))
#else
