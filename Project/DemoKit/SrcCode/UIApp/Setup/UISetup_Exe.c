...
#if(UI_RESOLUTION==UI_RESOLUTION_D800x480)//vincent@20150911-6
#include "../../uiwnd/d800x480/uiinfo/UICfgDefault.h"
#elif(UI_RESOLUTION==UI_RESOLUTION_D480x272)
#include "../../uiwnd/d480x272/uiinfo/UICfgDefault.h"
#elif(UI_RESOLUTION==UI_RESOLUTION_TOUCH_800x480)
#include "../../uiwnd/t800x480/uiinfo/UICfgDefault.h"
#else
#include "../../uiwnd/driver/uiinfo/UICfgDefault.h"
#endif
...
INT32 SetupExe_OnBeepKey(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    UI_SetData(FL_BEEP,uhSelect);//vincent@20150922-1
...
INT32 SetupExe_OnChangeDSCMode(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    switch(uiType)
    {
        case DSCMODE_CHGTO_PLAYBACK:
            uiChangeTo = PRIMARY_MODE_PLAYBACK;
            break;
        case DSCMODE_CHGTO_PHOTO:
            uiChangeTo = PRIMARY_MODE_PHOTO;
            break;
        case DSCMODE_CHGTO_MOVIE:
...
INT32 SetupExe_OnLCDOff(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    #if((_MODEL_DSC_!=_MODEL_DUAL_D333_)&&(_MODEL_DSC_!=_MODEL_DUAL_AONI328_))//vincent@20150911-5 //vincent@20150914-5
...
INT32 SetupExe_OnPowerOff(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    #if((_MODEL_DSC_!=_MODEL_DUAL_D333_)&&(_MODEL_DSC_!=_MODEL_DUAL_AONI328_))//vincent@20150911-2 //vincent@20150914-2
    ...
    switch(uhSelect)
    {
      ...
      #if (_MODEL_DSC_==_MODEL_DUAL_D333_)//vincent@20150906-2
        case POWER_1MIN:
...
INT32 SetupExe_OnSysReset(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
   ...
   // BKG_PostEvent(NVTEVT_BKW_DUMMY_WAIT);
    ...
    {
        Ux_SendEvent(&CustomMovieObjCtrl, NVTEVT_EXE_MOVIESIZE, 1, DEFAULT_MOVIE_SIZE_DUAL);
        Ux_SendEvent(&CustomMovieObjCtrl, NVTEVT_EXE_IMAGE_RATIO, 1, DEFAULT_MOVIE_SIZE_DUAL);

    }
    else
    {
        Ux_SendEvent(&CustomMovieObjCtrl, NVTEVT_EXE_MOVIESIZE, 1, DEFAULT_MOVIE_SIZE);
        Ux_SendEvent(&CustomMovieObjCtrl, NVTEVT_EXE_IMAGE_RATIO, 1, DEFAULT_MOVIE_SIZE);
    }
    #endif
