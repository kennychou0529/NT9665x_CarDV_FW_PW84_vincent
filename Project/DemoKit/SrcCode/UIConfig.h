...
/*
#define PS_POWERON_ANIMATION_1 ("POWERONANIMATION1")
#define PS_POWERON_ANIMATION_2 ("POWERONANIMATION2")
#define PS_POWERON_ANIMATION_3 ("POWERONANIMATION3")
#define PS_POWERON_ANIMATION_4 ("POWERONANIMATION4")
#define PS_POWERON_ANIMATION_5 ("POWERONANIMATION5")
#define PS_POWERON_ANIMATION_6 ("POWERONANIMATION6")
#define PS_POWERON_ANIMATION_7 ("POWERONANIMATION7")
#define PS_POWERON_ANIMATION_8 ("POWERONANIMATION8")
#define PS_POWERON_ANIMATION_9 ("POWERONANIMATION9")
#define PS_POWERON_ANIMATION_10 ("POWERONANIMATION10")
#define PS_POWERON_ANIMATION_11 ("POWERONANIMATION11")
*/
...
extern  BOOL UI_ShowLogoFile(char* secId,UINT32 *uiJpgAddr,UINT32 *uiJpgSize);
