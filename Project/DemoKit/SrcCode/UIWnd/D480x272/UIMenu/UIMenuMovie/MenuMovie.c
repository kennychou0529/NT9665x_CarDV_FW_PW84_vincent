...
#if (_MODEL_DSC_==_MODEL_DUAL_D333_)//vincent@20150824-1
...
// GPS Options
TMDEF_BEGIN_OPTIONS(MOVIE_GPS)//vincent@20150811-1
...
//#if(_MODEL_DSC_==_MODEL_DUAL_D333_)//vincent@20150811-1
...
int Movie_MenuCallback(UINT32 uiMessage, UINT32 uiParam)
{
    ...
    if (uiMessage == TMM_CONFIRM_OPTION)
    {
        ...
        case IDM_MOVIE_CYCLIC_REC:
            debug_msg("vincent@20150826-1 case IDM_MOVIE_CYCLIC_REC:%d\r\n", uwOption);
        ...
        case IDM_MOVIE_MOTION_DET:
            ...
            if (uwOption == MOVIE_MOTIONDET_ON)
            {
