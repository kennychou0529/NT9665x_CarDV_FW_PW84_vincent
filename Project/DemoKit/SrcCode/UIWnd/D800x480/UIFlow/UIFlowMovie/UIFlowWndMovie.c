   ...
   return NVTEVT_CONSUME;		
    ...
    switch(gMovData.State)
    {
        ...
        case MOV_ST_VIEW|MOV_ST_ZOOM:
            ...
            Ux_SendEvent(&UISetupObjCtrl,NVTEVT_EXE_CHANGEDSCMODE,1,DSCMODE_CHGTO_PHOTO);
            break;
...
INT32 UIFlowWndMovie_OnKeyUp(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    switch(gMovData.State)
    {
        ...
        case MOV_ST_VIEW|MOV_ST_ZOOM:
            ...
            Input_SetKeyMask(KEY_CONTINUE, FLGKEY_KEY_MASK_NULL);
            // changing primary mode
            Ux_SendEvent(&UISetupObjCtrl,NVTEVT_EXE_CHANGEDSCMODE,1,DSCMODE_CHGTO_PLAYBACK);
    ...
    case NVTEVT_05SEC_TIMER:
        ...
        if (g_uiRecordIngMotionDet==TRUE)
        {
            ...
            if (MD_Process()==TRUE)
            {
                ...
                if ((uiMotionDetStop>=20)&&(!g_bgsensor))//vincent@20150923-1
                {
                    uiMotionDetStop = 0;
                    switch(gMovData.State)
                    {
