...
#define DEFAULT_MOVIE_CAR_NUMBER          CAR_NUM_OFF//magic-20151010
#define DEFAULT_MOVIE_DUAL_VIEW_MODE         MOVIE_DUAL_VIEW_2T1B2S//vincent@20150915-2     
...
#define DEFAULT_LCDOFF               LCDOFF_1MIN
