...
void FlowMovie_StartRec(void)
{
    ...
    if (g_MovRecSelfTimerSec == 0)
    {
        ...
        #if (_MODEL_DSC_ == _MODEL_CARDV_K12_)//vincent@20150916-3
...
void FlowMovie_StopRec(void)
{
    ...
    gMovData.TimerCount = 0; //vincent@20150908-1
    //#NT#2012/10/23#Philex Lin - end
...
{
    static BOOL bRecordShow = FALSE;

//vincent@20150814-1 begin       
    switch (gMovData.State)
    {
    case MOV_ST_VIEW:
    ...
    case MOV_ST_REC | MOV_ST_ZOOM:
        ...
        #if(_MODEL_DSC_ == _MODEL_CARDV_K12_) //vincent@20150814-1
            gMovData.TimerCount++; //vincent@20150908-1
