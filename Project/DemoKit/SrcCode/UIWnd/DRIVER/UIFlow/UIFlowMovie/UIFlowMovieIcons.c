...
void FlowMovie_IconDrawCustomerLogoGeely(void)
{
    UxState_SetData(&UIFlowWndMovie_Status_CustomerLogoCtrl,STATE_CURITEM,UIFlowWndMovie_Status_CustomerLogo_ICON_GEELY);    
    UxCtrl_SetShow(&UIFlowWndMovie_Status_CustomerLogoCtrl, TRUE);
}
void FlowMovie_IconDrawCustomerLogoYoudaoshi(void)
{
    UxState_SetData(&UIFlowWndMovie_Status_CustomerLogoCtrl,STATE_CURITEM,UIFlowWndMovie_Status_CustomerLogo_ICON_YOUDAOSHI);    
    UxCtrl_SetShow(&UIFlowWndMovie_Status_CustomerLogoCtrl, TRUE);
}
void FlowMovie_IconHideCustomerLogo(void)
{
    UxCtrl_SetShow(&UIFlowWndMovie_Status_CustomerLogoCtrl, FALSE);
}
...
void FlowMovie_UpdateIcons(BOOL bShow)
{
...
#if(GPS_FUNCTION == ENABLE)//vincent@20150811-1
    ...
    else
    {
	  ...
	  FlowMovie_IconHideGuideLine();	 
        ...
        FlowMovie_IconDrawCustomerLogoGeely();
        #elif(CUSTOMER_TYPE==CUSTOMER_YOUDAOSHI)
        FlowMovie_IconDrawCustomerLogoYoudaoshi();
        #else
        FlowMovie_IconHideCustomerLogo();
        #endif
    #else
        FlowMovie_IconHideCustomerLogo();
    #endif
