...
CREATE_STATE_ITEM_DATA(ICON_OK_PLAY94,STRID_NULL,ICON_OK_PLAY,NULL) 
...
STATE_LIST_ITEM(ICON_OK_PLAY94)
STATE_LIST_END
...
CREATE_STATE_ITEM_DATA(ICON_FB_LEFT_BLUE103,STRID_NULL,ICON_FB_LEFT_BLUE,NULL) 
...
STATE_LIST_ITEM(ICON_FB_LEFT_BLUE103)
STATE_LIST_END
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin105Rect,0,0,81,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin105)
SHOW_MAP_BODY(Skin105Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin105,0,0,81,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text107,0,0,81,27,STRID_NULL,0,1280,0,0,3,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal104)
SHOW_MAP_BODY(Skin105)
SHOW_MAP_BODY(Text107)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal104,227,32,308,59)
...
SHOW_ITEM_GROUP(CMD_Group,Skin110,0,0,53,27)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon111, 0, 0, 53,25, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal109)
SHOW_MAP_BODY(Skin110)
SHOW_MAP_BODY(Icon111)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal109,189,207,242,234)

CREATE_STATE_ITEM_DATA(ICON_FF_RIGHT112,STRID_NULL,ICON_FF_RIGHT,NULL) 
CREATE_STATE_ITEM_DATA(ICON_FF_RIGHT_BLUE113,STRID_NULL,ICON_FF_RIGHT_BLUE,NULL) 
...
STATE_LIST_ITEM(ICON_FF_RIGHT112)
STATE_LIST_ITEM(ICON_FF_RIGHT_BLUE113)
STATE_LIST_END
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon116, 0, 0, 111,27, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal114)
SHOW_MAP_BODY(Skin115)
SHOW_MAP_BODY(Icon116)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal114,12,181,123,208)

CREATE_STATE_ITEM_DATA(ICON_VOL_0117,STRID_NULL,ICON_VOL_0,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_1118,STRID_NULL,ICON_VOL_1,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_2119,STRID_NULL,ICON_VOL_2,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_3120,STRID_NULL,ICON_VOL_3,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_4121,STRID_NULL,ICON_VOL_4,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_5122,STRID_NULL,ICON_VOL_5,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_6123,STRID_NULL,ICON_VOL_6,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_7124,STRID_NULL,ICON_VOL_7,NULL) 
CREATE_STATE_ITEM_DATA(ICON_VOL_8125,STRID_NULL,ICON_VOL_8,NULL) 
...
STATE_LIST_ITEM(ICON_VOL_0117)
STATE_LIST_ITEM(ICON_VOL_1118)
STATE_LIST_ITEM(ICON_VOL_2119)
STATE_LIST_ITEM(ICON_VOL_3120)
STATE_LIST_ITEM(ICON_VOL_4121)
STATE_LIST_ITEM(ICON_VOL_5122)
STATE_LIST_ITEM(ICON_VOL_6123)
STATE_LIST_ITEM(ICON_VOL_7124)
STATE_LIST_ITEM(ICON_VOL_8125)
STATE_LIST_END
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon128, 0, 0, 27,27, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal126)
SHOW_MAP_BODY(Skin127)
SHOW_MAP_BODY(Icon128)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal126,12,135,39,162)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin131Rect,0,0,59,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin131)
SHOW_MAP_BODY(Skin131Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin131,0,0,59,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text133,0,0,59,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal130)
SHOW_MAP_BODY(Skin131)
SHOW_MAP_BODY(Text133)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal130,12,181,71,208)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin136Rect,0,0,81,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin136)
SHOW_MAP_BODY(Skin136Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin136,0,0,81,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text138,0,0,81,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal135)
SHOW_MAP_BODY(Skin136)
SHOW_MAP_BODY(Text138)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal135,227,32,308,59)
